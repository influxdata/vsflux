...
# The purpose of this script is to automate the release process for the Flux VS Code Extension
...
# github will trigger a CI job that will publish the new release directly to
